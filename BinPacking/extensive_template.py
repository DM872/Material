...
def solve_linear_master_problem_by_cg(s, B):
    ...
    LRMP = gp.Model("Restricted Linear Master Problem")  
    LRMP.setParam(gp.GRB.param.Presolve, 0)
    LRMP.setParam(gp.GRB.param.Method, 0)
    ...
    while True:
        ...
        pi = [c.pi for c in LRMP.getConstrs()]
...
def solve_MIP_heuristic(s, B, t):
    ...
    # Solve the restricted Linear Master
...
def solveBinPacking(s, B):
    t, x = solve_linear_master_problem_by_cg(s, B)
